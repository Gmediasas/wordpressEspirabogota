<?php
/**
 * Tevent shortcode base class
 *
 * 
 * @package  Tevent Helper
 * @author  ThemeBucket <themebucket@gmail.com>
 */

abstract class Tevent_Shortcode {
    ...
    protected function get_icon( $name, $ext = 'png' ) {
        $dir = trailingslashit( TEVENT_HELPER_URL . 'assets/icons' );
