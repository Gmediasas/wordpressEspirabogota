               ...
               <div class="wpb_wrapper">
                  <div role="form" class="wpcf7" style="padding-bottom: 1rem;">
                     ...
                     <form action="" method="post" id="formPassword" name="formPassword"
                        class="wpcf7-form demo mailchimp-ext-0.5.08">
                        <div class="bg-black-transparent u-BorderRadius4 u-BoxShadow40
                           ...
                           <h3 class="text-black u-MarginTop0" style="text-align:
                              ...
                              <p style="text-align: center;margin-bottom:10px;">Ingresa tu email para recuperar la contraseña</p>
                           <div class="form-group">
                              <span class="wpcf7-form-control-wrap your-email"><input
                                 type="email" name="email" size="40" id="email"
                                 class="wpcf7-form-control wpcf7-text
                                 wpcf7-validates-as-required form-control
                                 form-control--white" aria-required="true"
                                 aria-invalid="false" placeholder="Email"></span>
                           </div>
                           <div class="form-group">
                              <input type="submit" value="Recuperar" id="savePassword"
                                 class="wpcf7-form-control wpcf7-submit btn btn-primary btn-block">
                                <span class="ajax-loader"></span>
                                 <a href="http://transforma40.gmediacompany.com/iniciar-sesion/"
                        ...
                        <p style="display: none !important"><span
                           ...
                           value="http://andicom.gmediacompany.com/wp-admin/edit.php?post_type=page"
                           class="wpcf7-form-control wpcf7-text referer-page"
                           aria-invalid="false"></span></p>
                        <!-- Chimpmail extension by Renzo Johnson -->
                         <input type="hidden" name="url" id="" value="http://transforma40.gmediacompany.com/nueva-contrasena">
                         <input type="hidden" name="registro" id="" value="7">
                     </form>
                  </div>
                  <div class="registro">
                    <span class="cuenta">
            ...
            <div class="modal fade" id="modalPassword" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     Hemos enviado un link al correo que ingresaste con un enlace para recuperar tu contraseña.
                     </div>
