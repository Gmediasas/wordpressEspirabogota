<div class="form-group col-sm-12">
    ...
    <span class="wpcf7-form-control-wrap your-name">
        <input type="file" name="responseFile[]" id="archivo_<?php echo$customCampos['idFormulario']?>" size="40" placeholder="Nombre de la persona de contacto" accept="image/png, image/jpeg, .doc,.docx,.xlsx,.pdf"
